...
<header class="site-header" id="site-header"><div class="shell header-shell"><a href="index.html" class="brand"><img src="assets/images/logo.png" alt="BodyNova Beauty Center" class="brand-logo"></a><nav class="desktop-nav"><a href="index.html#home">Home</a><a href="about.html">About</a><a href="index.html#how">How It Works</a><a href="index.html#moments">Moments</a><a href="index.html#services">Services</a><a href="index.html#offers">Offers</a><a href="index.html#reviews">Reviews</a><a href="index.html#contact">Contact</a></nav><div class="header-actions"><a href="#" class="header-call js-call">Call</a><a href="#" class="header-book js-book">Book Now</a></div><button class="menu-toggle" id="menu-toggle" type="button" aria-label="Open menu"><span></span><span></span><span></span></button></div><div class="mobile-panel" id="mobile-panel"><nav class="mobile-nav"><a href="index.html#home">Home</a><a href="about.html">About</a><a href="index.html#how">How It Works</a><a href="index.html#moments">Moments</a><a href="index.html#services">Services</a><a href="index.html#offers">Offers</a><a href="index.html#reviews">Reviews</a><a href="index.html#contact">Contact</a></nav><div class="mobile-actions"><a href="#" class="soft-btn js-call">Call Now</a><a href="#" class="main-btn js-whatsapp">WhatsApp</a></div></div></header>`;

const FOOTER_FALLBACK = `
<footer class="footer" id="contact"><div class="shell footer-shell"><div class="footer-topline"><p class="eyebrow">BodyNova Beauty Center</p><div class="footer-topline-actions"><a href="#" class="main-btn js-whatsapp">Book on WhatsApp</a><a href="#" class="soft-btn js-call">Call Now</a></div></div><div class="footer-grid footer-grid-cards"><div class="footer-card footer-intro-card"><h2>Luxury aesthetic care with calm precision.</h2><p>Clinic based beauty and body treatments designed for comfort, confidence, and refined results. Thoughtful care, advanced treatments, and a premium experience.</p><div class="footer-socials"><a href="#" id="footer-instagram">IG</a><a href="#" id="footer-facebook">FB</a><a href="#" id="footer-tiktok">TT</a><a href="#" id="footer-whatsapp">WA</a></div></div><div class="footer-card footer-menu-card"><h4>Menu</h4><div class="footer-link-list"><a href="index.html#home"><span>Home</span><small>01</small></a><a href="about.html"><span>About</span><small>02</small></a><a href="index.html#how"><span>How It Works</span><small>03</small></a><a href="index.html#moments"><span>Moments</span><small>04</small></a><a href="index.html#services"><span>Services</span><small>05</small></a><a href="index.html#offers"><span>Offers</span><small>06</small></a><a href="index.html#reviews"><span>Reviews</span><small>07</small></a></div></div><div class="footer-card footer-services-card"><h4>Services</h4><div class="footer-link-list"><a href="#services"><span>Body Sculpting</span></a><a href="#services"><span>Hydra Facial</span></a><a href="#services"><span>Body Contouring</span></a><a href="#services"><span>Body Slimming</span></a><a href="#services"><span>Skin Tightening</span></a><a href="#services"><span>Lymphatic Drainage</span></a></div></div><div class="footer-card footer-contact-card"><h4>Contact</h4><div class="footer-contact-stack"><div class="footer-contact-item"><span class="footer-label">Phone</span><a href="#" id="footer-phone-link"></a></div><div class="footer-contact-item"><span class="footer-label">Email</span><a href="#" id="footer-email-link"></a></div><div class="footer-contact-item"><span class="footer-label">Address</span><span id="footer-address"></span></div></div></div></div><div class="footer-bottom"><p id="footer-copy-text"></p><div class="payment-row"><span>Visa</span><span>Mastercard</span><span>Tabby</span><span>Apple Pay</span></div><div class="footer-bottom-links"><a href="#">Terms</a><a href="#">Privacy</a></div></div></div></footer>`;
